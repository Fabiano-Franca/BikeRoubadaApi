...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        // --- AJUSTE DE PORTA (FIX) ---
        // S� sobrescrevemos as URLs se a vari�vel PORT existir (Ambiente Railway).
        // Se for nulo, o ASP.NET usar� automaticamente o que est� no launchSettings.json.
        ...
        //Definimos a vers�o uma �nica vez para evitar inconsist�ncias
        var serverVersion = new MySqlServerVersion(new Version(9, 4, 0));

        // DbContext de Neg�cio
        ...
        { 
            using (var scope = app.Services.CreateScope())
            {
                ...
                try
                {
                    // 1. Migra o contexto de Dados (Neg�cio)
                    ...
                    Console.WriteLine("--- Todas as migra��es (Data e Api) aplicadas com sucesso! ---");
                }
                catch (Exception ex)
                {
